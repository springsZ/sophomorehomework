...
(function (e, t) {
        ...
        x(function () {
          ...
          l &&
            ...
            typeof d.style.zoom !== i &&
              ...
              (t.shrinkcontainerBlocks = 3 !== d.offsetWidth),
  ...
  x.extend({
    ...
    x.fn.extend({
      containerAll: function (e) {
        if (x.isFunction(e))
          return this.each(function (t) {
            x(this).containerAll(e.call(this, t));
          });
        if (this[0]) {
      ...
      containerInner: function (e) {
        return x.isFunction(e)
          ? this.each(function (t) {
              x(this).containerInner(e.call(this, t));
            })
          : this.each(function () {
              var t = x(this),
                n = t.contents();
              n.length ? n.containerAll(e) : t.append(e);
            });
      },
      container: function (e) {
        var t = x.isFunction(e);
        return this.each(function (n) {
          x(this).containerAll(t ? e.call(this, n) : e);
        });
      },
      uncontainer: function () {
        return this.parent()
          .each(function () {
  ...
  function nr(e, t, n) {
    ...
    n.queue ||
      ...
      n.overflow &&
        ((p.overflow = "hidden"),
        x.support.shrinkcontainerBlocks ||
          u.always(function () {
